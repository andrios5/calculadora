...
document.getElementById('resetEsq').addEventListener('click', function () {
    var e1 = document.getElementById('esq1');
    var e2 = document.getElementById('esq2');
    var e3 = document.getElementById('esq3');
    e1.value = '3';
    e2.value = '4';
    e3.value = '5';
});